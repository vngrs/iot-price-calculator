...
const components_table = [
  {
    ...
    type: 'result',
    cb: (state) => (0.25 * (state.inputs.number_of_devices / state.inputs.data_interval)).toFixed(2),
		typeOf: "GB",
  ...
  },
  {
    ...
    type: 'result',
    cb: (state) => (state.inputs.number_of_devices / state.inputs.data_interval).toFixed(2),
  ...
  },
  {
    ...
    type: 'result',
    cb: (state) => (5 * (0.25 * (state.inputs.number_of_devices / state.inputs.data_interval))).toFixed(2),
		typeOf: "GB",
  ...
  },
  {
    ...
    type: 'result',
    cb: (state) => ((state.inputs.number_of_devices / state.inputs.data_interval) / 500).toFixed(2),
    typeOf: "c4.large",
  ...
  },
  {
    ...
    type: 'result',
    cb: (state) => ((state.inputs.number_of_devices / state.inputs.data_interval) / 1000).toFixed(2),
